            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            no customer will allow to book hotel room when shutdown mode is turned on.
                        </p>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <iframe id="iframe" loading="lazy" class="border p-2 w-100" src=""></iframe>
                                </div>
