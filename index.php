...
<head>
    ...
    <title><?php echo $settings_res['site_title'] ?> | HOME</title>
    <style>
        .availability-form {
            margin-top: -50px;
            z-index: 2;
...
<body class="bg-light">
            ...
            <div class="col-lg-12 bg-white shadow p-4 rounded">
                ...
                <div class="row align-items-end">
                        ...
                        <div class="col-lg-3 mb-3">
                            <label class="form-label" style="font-weight: 500;" required>Check-In</label>
                            <input type="date" name="checkin" class="form-control shadow-none">
                        </div>
                        <!-- checkout date -->
                        <div class="col-lg-3 mb-3">
                            <label class="form-label" style="font-weight: 500;" required>Check-Out</label>
                            <input type="date" name="checkout" class="form-control shadow-none">
                        </div>
                        <!-- maximum adults in room -->
                        <div class="col-lg-3 mb-3">
                            <label class="form-label" style="font-weight: 500;">Adult</label>
                            <select class="form-select shadow-none" name="adult">
                                <?php 
                                    $guests_q = "SELECT MAX(adult) AS `max_adult`, MAX(children) AS `max_children` FROM `rooms` 
                                                 WHERE `status`='1' AND `removed` = '0'";
                                    $guest_res = mysqli_query($con,$guests_q);
                                    $guest_fetch = mysqli_fetch_assoc($guest_res);

                                    for($i = 1; $i <= $guest_fetch['max_adult']; $i++){
                        ...
                        <div class="col-lg-2 mb-3">
                            ...
                            <select class="form-select shadow-none" name="children">
                                <?php 
                                    for($i = 1; $i <= $guest_fetch['max_children']; $i++){
                                        echo "<option value='$i'>$i</option>";
                                    }
                                ?>
                            </select>
        ...
        <div class="row">
            <?php
                ...
                while ($room_data = mysqli_fetch_assoc($room_res))
                {
                    ...
                    //when bookings is full or site will shutdown then room book btn not showing to user
                    $book_btn = "";
                    if(!($settings_res['shutdown'])){
                    ...
                    if($rating_fetch['avg_rating']!=NULL)
                    {
                        ...
                        for($i = 0;$i < $rating_fetch['avg_rating']; $i++){
                            $rating_data .= "<i class='bi bi-star-fill me-3 text-warning'></i>";
                        }
            ...
            while ($row = mysqli_fetch_assoc($res)) {
                echo <<<data
                        <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
                            <img src="$path$row[icon]" width="120px">
    ...
    <div class="container">
        <div class="row">
            ...
            <!-- GOOGLE MAP LINK -->
            <div class="col-lg-8 col-mg-8 p-4 mb-lg-0 mb-3 bg-white rounded">
            ...
            <div class="col-lg-4 col-mg-4">
                ...
                <div class="bg-white p-4 rounded mb-4">
                    ...
                    if ($contact_res['pn2'] != '') {
                        echo <<<data
                                <a href="tel: +91 $contact_res[pn1] ?>" class="d-inline-block text-decoration-none text-dark">
                ...
                <div class="bg-white p-4 rounded mb-4">
                    ...
                    <br>
                    <a href="<?php echo $contact_res['insta'] ?>" class="d-inline-block mb-3">
                        <span class="badge bg-white text-dark fs-6 p-2">
