...
<head>
    ...
    <title><?php echo $settings_res['site_title'] ?> | ROOM DETAILS</title>
</head>
...
<body class="bg-light">
    ...
    <div class="container">
        <div class="row">
            ...
            <!-- Room Pictures Carousel -->
            <div class="col-lg-7 col-md-12 mb-4 px-4">
                <div id="roomCarousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <?php 
                            // get all thumbnail images of room
                            $room_img = ROOM_IMG_UPLOAD_PATH."thumbnail.jpg";
                                ...
                                while($img_res = mysqli_fetch_assoc($img_q)){
                                    echo "
                                        <div class='carousel-item $active_class'>
                                            <img src='".ROOM_IMG_UPLOAD_PATH.$img_res['image']."' class='d-block w-100 rounded'>
                                        </div>
                                    ";
                                    $active_class = '';
                                }
                ...
                <div class="card mb-4 border-0 shadow-sm rounded-3">
                    <div class="card-body">
                        <?php 
                            ...
                            echo <<<price
                                <h3>₹$room_data[price] per night</h3>
                            price;
            ...
            <div class="col-12 mt-4 px-4">
                ...
                <!-- Room review and ratting -->
                <div class="review-rating">
                    <h5 class="mb-3">Reviews and Rattings</h5>
                    <?php 
